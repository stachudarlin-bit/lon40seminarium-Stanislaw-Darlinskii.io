...
const digitColors = [
  ...
  { name: "Br頊owy", value: 1, css: "#7a3e1d" },
  { name: "Czerwony", value: 2, css: "#c62828" },
  { name: "Pomara鎍zowy", value: 3, css: "#ef6c00" },
  { name: "草速y", value: 4, css: "#fdd835" },
  ...
  { name: "Bia造", value: 9, css: "#f5f5f5" }
];

const multiplierColors = [
  { name: "Srebrny", value: 0.01, css: "#b0bec5" },
  { name: "Z這ty", value: 0.1, css: "#c9a227" },
...
const bands = {
  ...
  3: { stripe: stripe3, options: multiplierColors, title: "Opaska 3 (mno積ik)" },
...
function updateResult() {
  ...
  if (!b1 || !b2 || !b3 || !b4) {
    result.textContent = "Rezystancja: wybierz kolory wszystkich pask闚.";
    return;
  }
